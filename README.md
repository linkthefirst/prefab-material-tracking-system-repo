...
Warehouse and prefab material records were spread across manually entered material lists, SharePoint warehouse movement records, and sign-out workflows. This made it difficult to quickly determine whether a work order had all required material received, partially received, or missing.

## Solution

I built a Microsoft 365-based material tracking workflow that uses Power Query to normalize expected and received material data, compare quantities by work order, and create a cleaner view of material status.

The system supports:
- Expected vs. received material comparison
- Parsing multi-line warehouse movement records
- Source-record traceability through SharePoint item IDs
- Material sign-out support through Power Apps and Power Automate
- Sample data and sanitized scripts for public documentation

## Result

The workflow reduces manual lookup time, improves visibility into missing material, and provides a repeatable structure for tracking material handoffs by work order.
## Project Overview
...
- Add standardized material reference table
- Add fuzzy matching for inconsistent material descriptions
- Add Power BI dashboard templates
- Improve duplicate detection for imported material requisitions
- Add automated exception report for missing or over-received material
- Add receiver-facing controlled input form to improve naming consistency
